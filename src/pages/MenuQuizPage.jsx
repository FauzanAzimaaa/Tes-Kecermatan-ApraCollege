...
function MenuQuizPage(){
    const quizTitle = ["Tes Kecermatan Gabungan", "Tes Kecermatan Angka", "Tes Kecermatan Huruf", "Tes Kecermatan Simbol"]
    ...
    return(
        <>
            <section className="flex flex-row justify-evenly flex-wrap min-h-screen h-fit md:h-screen w-full pt-5 pb-20 md:p-20">
