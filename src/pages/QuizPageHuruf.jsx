...
import listQuestionAngka from "../data/listQuestionHuruf.json"
import dataQuestion from "../data/dataQuestionHuruf.json"
    ...
    <>
        ...
        {timeLeft === 0 && (
            <section className="flex flex-col items-center justify-center h-full w-full py-8 px-28">
                <QuizSection questionData={dataQuestion} questionType={"Kecermatan Huruf"} listQuestion={listQuestionAngka}/>
            </section>
        )}
        </section>
    </>
